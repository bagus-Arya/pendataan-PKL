                              ...
                              <table id="data-table-basic" class="table table-striped">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>{{ $f->akhirpkl }}</td>
                                      @if ($f->status =='1')
                                        <td><span style="color: green;">Sedang Pkl</span></td>
                                        <td><button class="btn btn-info btn-sm btn-block" disabled>Sudah Dikonfirmasi</button></td>
                                      @elseif ($f->status =='2')
                                        <td><span style="color: green;">Sudah Selesai Pkl</span></td>
                                        <td><button class="btn btn-info btn-sm btn-block" disabled>Selesai PKL</button></td>
                                      @else
                                        <td><span style="color: blue;">Menunggu Konfirmasi</span></td>
                                        <td><a href="{{ url('user/validasi/'.$f->id ) }}" class="btn btn-info btn-sm btn-block">Konfirmasi</a></td>
                                      @endif
                                      <div class="btn-group-lg btn-group-vertical">

                                        <td><a href="{{ url('user/hapus/'.$f->id ) }}" class="btn btn-info btn-sm btn-block">Hapus</a></td>
                                      </div>
                                    </tr>
                                  </tbody>
                                  @endforeach
                              </table>
                              <a href="{{ route('cetakpdf') }}" class="btn btn-primary">SIMPAN PDF</a>
                            </div>
                      </div>
                  </div>
              </div>
